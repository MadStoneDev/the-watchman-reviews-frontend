...
export default function SpecialMediaBlockSkeleton({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="grow relative flex w-full bg-transparent md:bg-transparent sm:lg:bg-neutral-800 rounded-2xl border border-transparent md:border-transparent sm:lg:border-neutral-50/30 overflow-hidden"
            ...
            <div className="flex w-[60%] md:w-[60%] sm:lg:w-auto pl-4 md:pl-4 sm:lg:pl-4 pr-0 md:pr-0 sm:lg:pr-8 py-8 flex-col gap-6 justify-center animate-pulse">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2">
                  <div className="w-5 h-5 bg-neutral-700 rounded-sm" />
                  <div className="w-16 h-3 bg-neutral-700 rounded-sm" />
                </div>

                <div className="w-3/4 h-6 bg-neutral-700 rounded-sm" />
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <div className="w-8 h-3 bg-neutral-700 rounded-sm" />
                  <div className="w-px h-4 bg-neutral-600" />
                  <div className="w-10 h-3 bg-neutral-700 rounded-sm" />
                </div>
              </div>
              ...
              <div className="grow flex flex-col gap-2">
                ...
                <div className="w-full h-3 bg-neutral-700 rounded-sm" />
                <div className="w-4/5 h-3 bg-neutral-700 rounded-sm" />
                <div className="w-3/5 h-3 bg-neutral-700 rounded-sm" />
              </div>
