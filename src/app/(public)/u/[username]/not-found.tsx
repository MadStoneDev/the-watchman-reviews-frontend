      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mb-6 flex justify-center">
          <div className="p-6 bg-indigo-900/20 rounded-full border-2 border-indigo-800/50">
            <IconUserOff size={64} className="text-indigo-400" />
          </div>
        </div>

        {/* Heading */}
        <h1 className="text-3xl md:text-4xl font-bold mb-4">User Not Found</h1>

        <p className="text-neutral-400 text-lg mb-8">
          This user doesn't exist or their profile may have been deleted.
        </p>
