      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mb-6 flex justify-center">
          <div className="p-6 bg-neutral-900 rounded-full border-2 border-neutral-800">
            <IconDeviceTv size={64} className="text-neutral-600" />
          </div>
        </div>
        ...
        <p className="text-neutral-400 text-lg mb-8">
          To view series details, you'll need to search for a specific show
          first.
        </p>
        ...
        <div className="mt-12 p-6 bg-neutral-900 rounded-lg border border-neutral-800 text-left">
          ...
          <ul className="space-y-2 text-sm text-neutral-400">
            <li className="flex items-start gap-2">
              ...
              <span>Use the search bar to find any TV show by title</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-lime-400 mt-1">•</span>
              <span>Browse popular and trending series</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-lime-400 mt-1">•</span>
              <span>Explore new releases and upcoming shows</span>
            </li>
          </ul>
        </div>
      </div>
